...
This release also makes saint detail images easier to view: tap an existing bundled saint image to open a larger offline preview, with no new downloads or tracking. Recently added saints now have expanded English and Spanish biographies.
...
| Release status | Production — live on Google Play |
